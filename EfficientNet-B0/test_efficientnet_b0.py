...
model_path = "efficientnet_b0_model.pth"
img_size = 256
...
df.to_excel("efficientnet_b0_wyniki_testu.xlsx", index=False)
print("✅ Wyniki zapisane do efficientnet_b0_wyniki_testu.xlsx")
...
plt.title("Skuteczność klasyfikacji EfficientNet-B0")
plt.axis("equal")
plt.savefig("efficientnet_b0_skutecznosc.png")
plt.close()
print("📊 Diagram zapisany do efficientnet_b0_skutecznosc.png")
