...
df.to_excel("mobilenetv2_wyniki_testu.xlsx", index=False)
print("✅ Wyniki zapisane do mobilenetv2_wyniki_testu.xlsx")
...
plt.title("Skuteczność klasyfikacji MobileNetV2")
plt.axis("equal")
plt.savefig("mobilenetv2_skutecznosc.png")
plt.close()
print("📊 Diagram zapisany do mobilenetv2_skutecznosc.png")
