...
df.to_excel("densenet121_wyniki_testu.xlsx", index=False)
print("✅ Wyniki zapisane do densenet121_wyniki_testu.xlsx")
...
plt.title("Skuteczność klasyfikacji DenseNet121")
plt.axis("equal")
plt.savefig("densenet121_skutecznosc.png")
plt.close()
print("📊 Diagram zapisany do densenet121_skutecznosc.png")
