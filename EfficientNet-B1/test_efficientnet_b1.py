...
df.to_excel("efficientnet_b1_wyniki_testu.xlsx", index=False)
print("✅ Wyniki zapisane do efficientnet_b1_wyniki_testu.xlsx")
...
plt.title("Skuteczność klasyfikacji EfficientNet-B1")
plt.axis("equal")
plt.savefig("efficientnet_b1_skutecznosc.png")
plt.close()
print("📊 Diagram zapisany do efficientnet_b1_skutecznosc.png")
